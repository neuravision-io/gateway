...
public class Routes {
    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                .route("echo-webservice", r -> r.path("/api/v1/echo-webservice/**")
                ...
                .route("user-webservice", r -> r.path("/api/v1/user-webservice/**")
                        .filters(f -> f.addResponseHeader("X-Response-Time", LocalDateTime.now().toString())
                                .filter((exchange, chain) -> {
                                    return chain.filter(exchange);
                                })
                ...
                .route("pdf_service_swagger", r -> r.path("/aggregate/echo-webservice/v3/api-docs")
                        ...
                        .uri("lb://echo-webservice"))
                .route("user_service_swagger", r -> r.path("/aggregate/user-webservice/v3/api-docs")
